...
const BoardSideMenu = ({ board, setBoard }) => {
  ...
  const toggleSubMenus = (menuName) => {
    if (menuName === "close") {
      ...
      document.querySelector("#submenu").style.transform = "translateX(0px)";
      // CONFIGURE SUBMENU
  ...
  return (
    <>
      ...
      <aside className="board-sidemenu">
        ...
        <ul>
          <li
            className="board-sidemenu_item"
            onClick={(e) => toggleSubMenus("#submenu_info")}
          >
        ...
        <ul>
          <li
            className="board-sidemenu_item"
            onClick={(e) => toggleSubMenus("#submenu_settings")}
          >
            <div className="board-sidemenu_item--icon">
          ...
          <li
            className="board-sidemenu_item"
            onClick={(e) => toggleSubMenus("#submenu_background")}
          >
            <div className="board-sidemenu_item--icon">
      ...
      >
            ...
            <ul>
              ...
              <li>
                <strong
                  style={{ cursor: "pointer" }}
                  onClick={(e) => {
                    document.querySelector("#add-member-board").style.display =
                      "block";
                  }}
                >
                  Add member
        ...
        <section id="submenu_settings" style={{ display: "none" }}>
          ...
          >
            ...
            <p className="close" onClick={(e) => toggleSubMenus("close")}>
              x
            </p>
          </div>
          <hr />
          <section>
            <h4>Privacy</h4>
            <p style={{ textTransform: "capitalize", color: "darkgray" }}>
              {board.privacy}
            </p>
            <h4 style={{ fontStyle: "italic", marginTop: "10px" }}>
              Privacy information
            </h4>
            <ul>
              <li>
                <p style={{ color: "darkgray" }}>
                  Private. Only MEMBERS of the board are allowed to access to it
                </p>
              </li>
              <li style={{ marginTop: "10px" }}>
                <p style={{ color: "darkgray" }}>
                  Workspace. Any MEMBER of the current workspace is able to
                  access the board
                </p>
              </li>
              <li style={{ marginTop: "10px" }}>
                <p style={{ color: "darkgray" }}>
                  Public. Anyone with the link can access to it, but can't
                  modify as only members of the board and users with
                  administrator role are able to edit
                </p>
              </li>
            </ul>
          </section>
        ...
        <section id="submenu_background" style={{ display: "none" }}>
          ...
          <div>
            ...
            <div className="backgrounds-container">
              <Backgrounds
                gradient="linear-gradient(315deg, rgba(2,0,36,1) 0%, rgba(9,9,121,1) 35%, rgba(0,212,255,1) 100%)"
                board={board}
              />
              <Backgrounds
                gradient="linear-gradient(315deg, rgba(204,94,0,1) 0%, rgba(255,160,0,1) 35%, rgba(255,250,0,1) 100%)"
                board={board}
              />
              <Backgrounds
                gradient="linear-gradient(315deg, rgba(0,144,255,1) 0%, rgba(144,255,221,1) 35%, rgba(60,249,255,1) 100%)"
                board={board}
              />
              <Backgrounds
                gradient="linear-gradient(315deg, rgba(241,142,255,1) 0%, rgba(232,84,255,1) 35%, rgba(87,0,147,1) 100%)"
                board={board}
              />
              <Backgrounds
                gradient="linear-gradient(315deg, rgba(0,0,0,1) 0%, rgba(109,71,115,1) 35%, rgba(0,0,0,1) 100%)"
                board={board}
              />
              <Backgrounds
                gradient="linear-gradient(315deg, rgba(52,0,0,1) 0%, rgba(154,24,24,1) 35%, rgba(255,0,0,1) 100%)"
                board={board}
              />
            </div>
            <hr />
      ...
      {isChanged ? (
        <div className="successModal">
          <p
            style={{ textAlign: "end", color: "white", cursor: "pointer" }}
            onClick={(e) => {
